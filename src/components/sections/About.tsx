...
const STATS: Stat[] = [
  { label: "Years of Experience", value: "4+", emoji: "💻" },
  { label: "Projects Completed", value: "50+", emoji: "🚀" },
  { label: "Happy Clients", value: "15+", emoji: "❤️" },
                ...
                <div className="container mx-auto px-4 md:px-8">
                        ...
                        <div className="grid lg:grid-cols-2 gap-16 items-start">
                                              ...
                                              <div className="space-y-6">
                                                            <div className="glass-card rounded-2xl border border-border p-8 space-y-5">
                                                                            ...
                                                                            <p className="text-muted-foreground leading-relaxed">
                                                                                              ...
                                                                                              building digital financial services used by 10,000+ users.
                                                                            </p>p>
                                                                            <p className="text-muted-foreground leading-relaxed">
                                                                                              When I&apos;m not coding, you&apos;ll find me exploring new AI research or enjoying
                              ...
                              <motion.div
                                                  ...
                                                  >
                                                  <div className="text-xl mb-1">{stat.emoji}</div>div>
                            ...
                            <motion.div
                                              ...
                                              >
                                              <div className="mb-4 text-2xl">{item.emoji}</div>div>
